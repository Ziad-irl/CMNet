...
cells = [
    ...
    },
    {
        ...
        "source": [
            ...
            "\n",
            "# Organize downloaded weights\n",
            "!find models_tmp/ -name \"resnet18_msceleb.pth\" -exec mv {} models/ \\;\n",
            "!find models_tmp/ -name \"rafdb.pth\" -exec mv {} experiment/rafdb/ \\;\n",
            "!find models_tmp/ -name \"affectnet-7.pth\" -exec mv {} experiment/affectnet-7/ \\;\n",
            "!find models_tmp/ -name \"*.pth\" -exec mv {} models/ \\;\n"
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "source": [
            ...
            "import shutil\n",
            "import os\n",
            "# Check if a new best checkpoint was produced by training\n",
            "best_ckpt = glob.glob('checkpoint/*_best.pth')\n",
            "if best_ckpt:\n",
            "    print(f'Found newly trained checkpoint: {best_ckpt[0]}. Copying for evaluation...')\n",
            "    shutil.copy(best_ckpt[0], 'experiment/rafdb/rafdb.pth')\n",
            "elif os.path.exists('experiment/rafdb/rafdb.pth'):\n",
            "    print('No newly trained checkpoint found. Falling back to the downloaded pre-trained model.')\n",
            "else:\n",
            "    print('No checkpoint found! Evaluation will likely fail.')\n"
        ]
    },
    {
        "cell_type": "code",
